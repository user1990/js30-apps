...
const oldest = inventors.sort((firstPerson, secondPerson) => {
  const firstGuy = firstPerson.passed - firstPerson.year;
  const secondGuy = secondPerson.passed - secondPerson.year;
...
const alpha = people.sort((firstName, lastName) => {
  const aLast = firstName.split(', ');
  const bLast = lastName.split(', ');
